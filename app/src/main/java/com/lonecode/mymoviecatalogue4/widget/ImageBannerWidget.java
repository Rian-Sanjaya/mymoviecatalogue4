...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.lonecode.mymoviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.lonecode.mymoviecatalogue.EXTRA_ITEM";
